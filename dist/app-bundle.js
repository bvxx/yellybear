...
if (document.querySelector('#accordion-example-heading-1')) {
    ...
    * options: optional
    */
    var accordion = new flowbite_1.Accordion(accordionItems, options);
...
if (document.getElementById('carousel-item-1')) {
    var carousel_1 = new flowbite_1.Carousel(items, options);
    carousel_1.cycle();
...
if (document.querySelector('#profile-tab-example')) {
    ...
    * options: optional
    */
    var tabs = new flowbite_1.Tabs(tabElements, options);
